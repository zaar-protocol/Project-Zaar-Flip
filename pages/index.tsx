        ...
        <div className="md:hidden space-y-3 w-full px-4">
          <div className="flex justify-between">
            <div className="w-1/2 pr-2">
              <div className="text-light-green mb-1 text-sm">PICK SIDE:
              </div>
          ...
          <div>
            <div className="text-light-green mb-1 text-sm">WAGER
          ...
          <div className="flex justify-between">
            <div className="w-1/2 pr-2">
              <div className="text-light-green mb-1 text-sm">COINS AMOUNT
              </div>
            ...
            <div className="w-1/2 pl-2">
              <div className="text-light-green mb-1 text-sm flex items-center">MIN HEADS / TAILS
              </div>
              <div className="bg-dark-gray rounded-sm p-2 flex items-center h-10">
                <div className="text-light-green text-center mr-2 text-sm">x</div>
        ...
        <div className="hidden md:grid grid-cols-3 gap-4 w-full max-w-4xl mx-auto mb-4 h-50">
          <div className="space-y-3">
            ...
            <div className="text-light-green mb-1 text-sm flex items-center">
              COINS AMOUNT
              <Tooltip text={"This determines how many virtual coins you&apos;re flipping in one game. You can choose from 1 to 10 coins."}/>
            ...
            <div>
              <div className="text-light-green mb-1 text-sm mt-6">MIN HEADS / TAILS
              <Tooltip text={"This sets the minimum number of heads (or tails, depending on your chosen side) you need to win. For example, if you set this to 3 with 5 coins, you'd need at least 3 out of 5 coins to land on your chosen side to win."}/>
          ...
          <div className="space-y-3">
            ...
            <div>
              <div className="text-light-green mb-1 text-sm mt-6">PICK SIDE:
                <Tooltip text={"This lets you choose which side of the coin you're betting on - heads or tails. The side you pick becomes your `winning` side for that game. In essence, you're betting on getting at least a certain number of your chosen side (heads or tails) when flipping a set number of coins. The more challenging your bet, the higher your potential winnings."}/>
              </div>
              <div className="flex space-x-4">
                <div
                  onClick={() => handleSideChange('heads')}
