...
export default function Staking() {
    ...
    const { stakedBalance, earnedBalance, poolPercentage, walletBalance, isLoading, cooldownProgress, timeRemaining } = useStakingBalance(address || '0x0000000000000000000000000000000000000000');
            ...
            <div className="flex flex-col items-center justify-center h-screen gap-6">
                ...
                <div className=" flex flex-row items-center justify-center gap-4 bg-black bg-opacity-50 p-6 gap-4">
                    <div className="flex text-sm flex-col items-start text-hoverGray justify-center gap-2">
                        Total Initia Staked
                        <h1 className="text-3xl text-yellow">{stakedBalance ? formatEther(BigInt(stakedBalance)) : '0'}</h1>
                    </div>
                    <div className="flex text-sm flex-col items-start text-hoverGray justify-center gap-2">
                    ...
                    <div className="flex text-sm flex-col items-start text-hoverGray justify-center gap-2">
                        ...
                        <h1 className="text-3xl text-yellow">{earnedBalance ? formatEther(BigInt(earnedBalance)) : '0'}</h1>
                    </div>
                </div>
                <div className="flex flex-col md:flex-row w-full md:w-[60%] items-center justify-center gap-4">
                   <div className="flex flex-col items-start justify-center w-[50%] h-full">
                    ...
                    <p className="text-3xl text-white"> EARN <span className="text-yellow">REWARDS</span></p>
                    <p className="pt-6 text-white">Be the house! Take the other side of the wager by depositing INIT into the pool. Your deposit may accrue rewards generated by protocol revenues. But be aware! <span className="text-yellow">Deposits may also lose value, if and when there are a lare amount of user payouts.</span> </p>
                    <div className="text-white flex flex-row items-start justify-center gap-2">
                        ...
                        <Link className="flex flex-row hover:underline hover:text-white items-center justify-center gap-2" href="https://gitbook.zaar.market/">
                        Docs 
                        <FaExternalLinkAlt />
                        </Link>
                    </div>
                   ...
                   <div className="flex flex-col items-center justify-center w-[50%] h-full ">
                    <div className="bg-black text-white flex flex-row items-center justify-center w-full">
                        ...
                        <div className={`${currentTab === "deposit" ? "h-[2px] w-full bg-yellow" : "h-[2px] w-full bg-white"}`}></div>
                        </div>
                        ...
                        <div className={`${currentTab === "withdraw" ? "h-[2px] w-full bg-yellow" : "h-[2px] w-full bg-white"}`}></div>
                        </div>
                    ...
                    <div className="flex flex-col bg-white bg-opacity-5 w-full items-center justify-center p-6 gap-6">
                        <div className="flex flex-row w-full items-center justify-center">
                            <div className="flex flex-col items-start justify-center w-1/2 gap-2">
                                ...
                                <div className="flex flex-row items-center justify-between gap-2 bg-black border-2 border-white p-2 w-[70%]">
                                    <div className="flex flex-row items-center justify-center gap-2">
                                        <Image src="/zaar-flip-tails.png" alt="Initia Logo Coin" width={20} height={20} />
                                        <p className="text-white">INIT</p>
                                    </div>
                                    <FaChevronDown />
                                </div>
                                <p className="text-white">You have {Number(walletBalance).toFixed(2)} INIT</p>
                            </div>
                            ...
                            <div className="flex flex-col items-start justify-center w-1/2 gap-2">
                                ...
                                <p className="text-white">≈ ${Number(walletBalance).toFixed(2)}</p>
                            </div>
                        </div>
                        <button className="bg-light-gray hover:bg-white transition duration-300 text-black w-full h-10">
                            {Number(walletBalance) === 0 ? 'Insufficient Balance' : 'Approve'}
                        </button>
                    </div>
                    }
                    {currentTab === "withdraw" && 
                    <div className="flex flex-col bg-white bg-opacity-5 w-full items-center justify-center p-6 gap-6">
                        <div className="flex flex-row w-full items-center justify-center">
                            <div className="flex flex-col items-start justify-center w-1/2 gap-2">
                                ...
                                <p className="text-white">You have {Number(stakedBalance).toFixed(2)} INIT staked</p>
                            </div>
                            ...
                            <div className="flex flex-col items-start justify-center w-1/2 gap-2">
                                ...
                                <p className="text-white">≈ ${Number(stakedBalance).toFixed(2)}</p>
                            </div>
                        </div>
                        ...
                        >
                            {Number(stakedBalance) === 0 ? 'No Staked Balance' : 'Withdraw'}
                        </button>
                    </div>
                    }
                   </div>
